...
class NMRControl(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.fit_button.clicked.connect(self.fit_fid)

        # FID Series Acquisition Signals

        self.fid_dir = ""
        self.save_directory_button.clicked.connect(self.set_fid_dir)
    ...
    def set_fid_dir(self):
        ...
        self.save_directory_display.setText(fn)
        self.fid_dir = fn
    ...
    def get_fid_series(self):
        ...
        self.timer.start(self.afid_sampling_period_spin.value()*6*1e3)
    ...
    def fit_fid(self):
        ...
        if self.bounds_checkbox.isChecked():
            lower_bounds = [self.vpp_bound_lower.value(),
                            ...
                            self.phase_diff_bound_lower.value(),
            ...
            upper_bounds = [self.vpp_bound_upper.value(),
                            ...
                            self.phase_diff_bound_upper.value(),
        ...
        if self.initial_checkbox.isChecked():
            p0 = [self.vpp_bound_initial.value(),
                  ...
                  self.phase_diff_bound_initial.value(),
        ...
        self.fid_fitting_plot.axes.plot(timescale, exp_dec(timescale,*popt),'r-')
        self.fid_fitting_plot.axes.plot(timescale, self.data,'b-')
        ...
        self.phase_diff_found.setText(str(popt[3]) + ' rad')
